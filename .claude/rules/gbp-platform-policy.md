...
- ❌ **NEVER solicit reviews. From anyone. Ever.** Yelp: *"Don't ask anyone to review your business, be it customers, mailing list subscribers, friends, family, etc."* and *"Don't ask for reviews after requesting customer feedback in other places like surveys or contact forms."* Penalty is not just filtering to "not recommended" — Yelp runs a **Consumer Alerts** program that puts a **public pop-up warning on the business page**. Google permits asking; **Yelp does not**. Never carry a Google review-request tactic across to Yelp.
...
- ❌ **No free "Yelp Posts" surface exists.** The business-updates product is **Yelp Connect**, which is **paid** (bundled in the Page Upgrade Package). Do not draft "Yelp posts" as if a free surface existed.
...
- **Hashtag cap is 5**, not 30, since Instagram's 18–19 Dec 2025 change. The cap counts **caption and comments combined**, so splitting them buys nothing. Use 3–5 specific tags.
  - ⚠️ **Instagram's own Help Center still says 30 and is stale.** The official page contradicts the platform's own newer announcement. This is the documented counter-example to "official source always wins" in `trusted-sources.md`: when an official help page conflicts with a newer official announcement from the same platform, **the announcement wins** — and say so explicitly.
