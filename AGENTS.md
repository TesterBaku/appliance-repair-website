...
npm run test:functional  # 263 Playwright tests — nav, dropdowns, forms, accordions, articles, hubs
```
...
- Playwright for functional testing (263 tests in `test/functional.spec.js`)