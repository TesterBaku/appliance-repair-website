...
- CLI detector: ran successfully, exit 2 (findings reported), 1 finding total (false positive, pre-existing content, not new). The slug above is the tool's own truncation of the target list; the file is otherwise unchanged.
