...
| Metric | Value |
|---|---|
| Distinct reviews currently on >=1 hub | 89 |
| On exactly 1 hub (1 free slot each) | 7 |
| On exactly 2 hubs (at cap) | 78 |
...
| Michele Ohanian | refrigerator-repair-cost-hub, whirlpool-hub |
